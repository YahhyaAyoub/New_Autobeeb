...
class ListingModel extends Component {
  ...
  componentDidMount () {
    ...
    if (this.props.Models && this.props.Models.length <= 1) {
      ...
      return (
        <View style={{}}>
          <TextInput
            ...
            onChangeText={text => {
              tempModels = this.state.FullModels.filter (item => {
                return item.Name.toUpperCase ().includes (text.toUpperCase ());
              });
              this.setState ({Models: tempModels, text});
            }}
